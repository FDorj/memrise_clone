...
def select_topic(request):
    ...
    return render(request, 'group2/select_topic.html', {'lessons': lessons})

def view_lesson(request, lesson_id):
    lesson = get_object_or_404(Lesson, id=lesson_id)
    exercises = lesson.exercises.all()  # Fetch all exercises related to the lesson
    return render(request, 'group2/view_lesson.html', {'lesson': lesson, 'exercises': exercises})
